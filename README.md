...
A Helm chart is provided in [charts/elasticsearch-query-exporter](charts/elasticsearch-query-exporter), with defaults for running next to an [ECK](https://www.elastic.co/guide/en/cloud-on-k8s/current/index.html)-managed Elasticsearch cluster. See that chart's [README.md](charts/elasticsearch-query-exporter/README.md).
